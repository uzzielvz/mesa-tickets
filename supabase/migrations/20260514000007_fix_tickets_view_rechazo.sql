-- ================================================================
-- FIX: recrear tickets_with_status (estado rechazado + columna datos)
-- Correr si falló 20260514000003 con error 42P16 area_nombre / datos
-- ================================================================

-- Las funciones de rechazo (si el script E falló a medias, vuelven a aplicarse)
...
-- Postgres no permite CREATE OR REPLACE si t.* cambió de columnas (ej. se agregó datos)
